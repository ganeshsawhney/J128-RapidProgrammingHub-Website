  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a onclick="loadDoc('home.php');" href="#HOME">HOME</a></li>
        <li ><a onclick="loadDoc('notice.php');" href="#NOTICES">NOTICES</a></li>
        <li><a onclick="loadDoc('sm.php');" href="#SM">SM</a></li>
        <li><a onclick="loadDoc('schedule.php');" href="#SCHEDULE">SCHEDULE</a></li>
        <li><a onclick="loadDoc('contact.php');" href="#CONTACT">CONTACT</a></li>
      </ul>
    </div>
  </div>
</nav>
